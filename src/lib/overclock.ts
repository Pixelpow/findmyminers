...
export const TIER_META: Record<OcTier, TierMeta> = {
  eco: {
    ...
    descEn: 'Lower voltage and frequency: less noise, less heat, less power. Ideal at night.',
  ...
  balanced: {
    ...
    shortEn: 'Factory tuning',
    desc: 'Valeurs proches du stock : le meilleur compromis stabilité / efficacité au quotidien.',
    descEn: 'Near-stock values: the best stability / efficiency trade-off for daily use.',
  ...
  turbo: {
    ...
    shortEn: 'More hashrate',
    desc: 'Overclock sain : gain de hashrate notable en gardant des marges thermiques. Ventilation à surveiller.',
    descEn: 'Healthy overclock: a solid hashrate gain while keeping thermal headroom. Watch cooling.',
  ...
  extreme: {
    ...
    descEn: 'Pushes the chip near its limits. For setups with reinforced heatsinks/cooling only. Risk of instability and accelerated wear.',
